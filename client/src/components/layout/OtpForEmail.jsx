...
export default function OtpForEmail() {
                  ...
                  <div className="relative mx-auto mb-5 flex h-80 max-w-md items-center justify-center">
                    ...
                    <div className="relative flex items-center justify-center">
                      <div className="relative h-52 w-56 rounded-[2rem] bg-gradient-to-br from-violet-200 via-violet-100 to-white shadow-xl">
                        <div className="absolute left-0 top-0 h-full w-full overflow-hidden rounded-[2rem]">
                          <div className="absolute bottom-0 left-0 h-28 w-28 rotate-45 bg-violet-400" />
                          <div className="absolute bottom-0 right-0 h-28 w-28 -rotate-45 bg-violet-300" />
                        </div>
              ...
              <div className="mx-auto max-w-md">
                ...
                >
                  {mode === "mobile" ? (
                    <label className="block">
                      ...
                      <div className="flex min-h-12 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition focus-within:border-violet-500 focus-within:ring-4 focus-within:ring-violet-100">
                        <button
                          type="button"
                          className="flex items-center gap-3 border-r border-slate-200 px-4 text-slate-800 text-sm sm:px-5"
                        >
                        ...
                        <input
                          ...
                          className="w-full min-w-0 px-4 text-sm outline-none placeholder:text-slate-400"
                        />
                      </div>
                    </label>
                  ) : (
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex min-h-12 w-full items-center justify-center gap-3 rounded-2xl bg-[rgb(var(--primary))] px-6 text-sm font-semibold text-white shadow-lg shadow-violet-200 transition hover:bg-violet-700 focus:outline-none focus:ring-4 focus:ring-violet-200 disabled:opacity-70"
                  >
                    <Send size={22} />
                ...
                {mode === "mobile" ? (
                  <button
                    ...
                    className="flex min-h-12 w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-6 text-sm font-semibold text-slate-900 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-slate-100"
                  >
                    <Mail size={22} />
                    Continue with Email
                  </button>
                ...
                {mode === "email" && (
                  <button
                    onClick={() => setMode("mobile")}
                    className="mx-auto mt-10 flex items-center gap-2 text-sm font-medium text-[rgb(var(--secondary))] transition hover:text-violet-700"
                  >
                    <ArrowLeft size={18} />
